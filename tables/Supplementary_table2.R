...
sbp=import("results/res_fastlm.24SBP_multi_model.tsv")
dbp=import("results/res_fastlm.24DBP_multi_model.tsv")
sbp_sd=import("results/res_fastlm.sysSD_multi_model.tsv")
dbp_sd=import("results/res_fastlm.diaSD_multi_model.tsv")
...
write.table(basic,file="results/tables/Supplementary_table2.tsv",col.names=T,row.names=F,sep="\t")
print(Sys.time())
