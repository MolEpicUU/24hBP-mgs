...
#save the result
write.table(sbp1,file=paste(output.folder,"/res_fastlm.24SBP_multiBMI_model.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")

write.table(dbp1,file=paste(output.folder,"/res_fastlm.24DBP_multiBMI_model.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")

write.table(sbp_sd1,file=paste(output.folder,"/res_fastlm.sysSD_multiBMI_model.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")

write.table(dbp_sd1,file=paste(output.folder,"/res_fastlm.diaSD_multiBMI_model.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")
