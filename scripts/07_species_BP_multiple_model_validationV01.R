...
res1=import("results/res_fastlm.24SBP_multi_model.tsv")
res2=import("results/res_fastlm.24DBP_multi_model.tsv")
...
#save the result
write.table(sbp1,file=paste(output.folder,"/res_fastlm.SBP_multi_model_validation.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")

write.table(dbp1,file=paste(output.folder,"/res_fastlm.DBP_multi_model_validation.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")
