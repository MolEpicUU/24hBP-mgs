...
#save the result
write.table(res.lm1,file=paste(output.folder,"/res_fastlm.24SBP_multi_model.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")

write.table(res.lm2,file=paste(output.folder,"/res_fastlm.24DBP_multi_model.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")

write.table(res.lm5,file=paste(output.folder,"/res_fastlm.sysSD_multi_model.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")

write.table(res.lm6,file=paste(output.folder,"/res_fastlm.diaSD_multi_model.tsv",sep=""),
            col.names = T,row.names = F,sep="\t")
